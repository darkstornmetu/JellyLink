	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float4 __normalMap =  tex2D(_BumpMap, positionWS.xz * _BaseMap_ST.xy + _BaseMap_ST.zw);
				float __bumpScale = ( _BumpScale );
				float4 __albedo = ( tex2D(_BaseMap, positionWS.xz * _BaseMap_ST.xy + + _BaseMap_ST.zw));
				float4 __mainColor = ( _BaseColor.rgba );
				float __alpha = ( __albedo * __mainColor.a );
...
/* TCP_DATA u config(unity:"2021.3.0f1";ver:"2.7.4";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2020_1","UNITY_2021_1","TEMPLATE_LWRP","BUMP","BUMP_SHADER_FEATURE","BUMP_SCALE","SHADOW_COLOR_MAIN_DIR"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH d30d0b7eb6665711d0c5fcbf0ce275d0 */
